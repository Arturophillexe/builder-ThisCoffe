...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // In a real app, validate email/password with a backend
      // For now, use email as username and determine role (e.g., "owner@thiscoffee.com" for owner)
      const role = formData.email === "owner@thiscoffee.com" ? "owner" : "user";
      login(formData.email.split("@")[0], role); // Use email prefix as username
      setIsLoading(false);
